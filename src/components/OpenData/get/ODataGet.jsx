...
const ODataGet = () => {
  ...
  async function getInfo() {
    await axios
      .get("https://api.agroxizmatlar.uz/open-document")
      .then((res) => {
  ...
  const deleteFun = async (id) => {
    await axios
      .delete(`https://api.agroxizmatlar.uz/open-document/${id}`, {
  ...
  return (
    <Content>
      ...
      <Box>
        <Table>
          <Tr1>
            <Th style={{ paddingLeft: "15px" }}>Nomi</Th>
            <Th>Qaror Soni</Th>
            <Th>Fayl</Th>
            <Th>Menu</Th>
          </Tr1>
