...
const OurVeterans = () => {
  ...
  async function getInfo() {
    await axios.get("https://api.agroxizmatlar.uz/agency-veteran").then(res => {
  ...
  const deleteFun = async id => {
    await axios
      .delete(`https://api.agroxizmatlar.uz/agency-veteran/${id}`, {
        ...
        <Table>
          ...
          {response?.map((e, i) => (
            <Tr key={i}>
              ...
              <Td>
                <Text2>{e.nameUz}</Text2>
              </Td>
              <Td style={{ marginRight: "-105px" }}>
                <Text1>{e.positionUz}</Text1>
              </Td>
              <Td>
                <Text1>{e.date}</Text1>
              </Td>
